...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_cmt", type=str, default='/path/to/cmt.pt', help="CMT")
    parser.add_argument("--ckpt_teacher", type=str, default='models/DiTs/Dinov2/wReg_base/ImageNet512/DiTDH-XL_ep400/stage2_model.pt', help="Compulsory teacher checkpoint path for distillation.")

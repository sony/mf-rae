...
def main(args):
    ...
    model = DiTwDDTHead_MF(
        ...
        depth = [28, 2], # [28, 2] (XL), # [12, 2], (B, S)
        num_heads = [16, 16], # [16, 16] (XL), # [12, 16] (B), # [6, 16], (S)
        mlp_ratio = 4.0,
    ...
    for epoch in range(epochs):
        ...
        for x, y in loader:
            ...
            with autocast(**autocast_kwargs):
                loss_all = transport.training_losses_cmt_512(model, model_teacher, sample_fn, x, model_kwargs)
            ...
            if torch.isnan(loss_tensor) or torch.isinf(loss_tensor):
                print(f"NaN detected. Stopping training.")
